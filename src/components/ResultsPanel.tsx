...
import { Eye, EyeOff, House, Map as MapIcon, ChevronDown, BarChart3, Trophy } from 'lucide-react';
                    ...
                    <span className="flex items-center gap-2">
                      ...
                      {tab.avgReliability !== undefined && (
                        <span
                          ...
                          title={t('resultsPanel.averageReliability', {
                            percent: (tab.avgReliability * 100).toFixed(0),
                          })}
                        >
                    ...
                    >
                      ...
                      <span
                        className={cn(
                          ...
                          stop.isHome ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-600',
                        )}
                      >
                        {stop.isHome ? <House className="w-3.5 h-3.5" /> : stop.sequence}
                      </span>
