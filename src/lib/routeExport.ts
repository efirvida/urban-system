...
export async function generateRoutePlanDocx(
  ...
  const summaryData = [
    ...
    [
      ...
      formatDuration(days.reduce((sum, d) => sum + d.totalTime, 0), lng),
    ],
  ];
                  ...
                  children: [
                    new TextRun({
                      text:
                        stop.distanceFromPrev > 0
                          ? String(
                              Math.round(stop.distanceFromPrev * 100) / 100,
                            )
                          : "—",
                      size: 20,
                    }),
                  ...
                  children: [
                    new TextRun({
                      text:
                        stop.cumulativeDistance > 0
                          ? String(
                              Math.round(stop.cumulativeDistance * 100) / 100,
                            )
                          : "—",
                      size: 20,
                    }),
                  ...
                  children: [
                    new TextRun({
                      text:
                        stop.cumulativeTime > 0
                          ? String(
                              Math.round(stop.cumulativeTime * 100) / 100,
                            )
                          : "—",
                      size: 20,
                    }),
  ...
  const summaryRows = [
    ...
    [
      t("routeExport.totalHours"),
      {
        ...
        v:
          Math.round(
            days.reduce((sum, d) => sum + d.totalTime, 0) * 100,
          ) / 100,
        z: "0.00",
      } as XLSX.CellObject,
    ],
